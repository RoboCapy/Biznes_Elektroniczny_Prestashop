...
class Ps_FeaturedProductsDiscounted extends Module implements WidgetInterface
{
    private $templateFile;

    public function __construct()
    {
        $this->name = 'ps_featuredproductsdiscounted';
        ...
        $this->displayName = $this->trans('Featured products discounted', [], 'Modules.Featuredproducts.Admin');
    ...
    public function install()
    {
        ...
        Configuration::updateValue('HOME_FEATURED_NBR_SEC', 8);
        Configuration::updateValue('HOME_FEATURED_CAT_SEC', (int) Context::getContext()->shop->getCategory());
        Configuration::updateValue('HOME_FEATURED_RANDOMIZE_SEC', false);
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('submitHomeFeatured')) {
            ...
            if (count($errors)) {
                ...
                Configuration::updateValue('HOME_FEATURED_NBR_SEC', (int) $nbr);
                Configuration::updateValue('HOME_FEATURED_CAT_SEC', (int) $cat);
                Configuration::updateValue('HOME_FEATURED_RANDOMIZE_SEC', (bool) $rand);
    ...
    {
        return [
            'HOME_FEATURED_NBR_SEC' => Tools::getValue('HOME_FEATURED_NBR_SEC', (int) Configuration::get('HOME_FEATURED_NBR_SEC')),
            'HOME_FEATURED_CAT_SEC' => Tools::getValue('HOME_FEATURED_CAT_SEC', (int) Configuration::get('HOME_FEATURED_CAT_SEC')),
            'HOME_FEATURED_RANDOMIZE_SEC' => Tools::getValue('HOME_FEATURED_RANDOMIZE_SEC', (bool) Configuration::get('HOME_FEATURED_RANDOMIZE_SEC')),
        ];
    }
    ...
    public function getWidgetVariables($hookName = null, array $configuration = [])
    {
        ...
        if (!empty($products)) {
            return [
                'products' => $products,
                'allProductsLink' => Context::getContext()->link->getCategoryLink($this->getConfigFieldsValues()['HOME_FEATURED_CAT_SEC']),
            ];
        }
    ...
    {
        $category = new Category((int) Configuration::get('HOME_FEATURED_CAT_SEC'));
        ...
        $nProducts = Configuration::get('HOME_FEATURED_NBR_SEC');
        if ($nProducts < 0) {
            $nProducts = 12;
        }
        ...
        if (Configuration::get('HOME_FEATURED_RANDOMIZE_SEC')) {
