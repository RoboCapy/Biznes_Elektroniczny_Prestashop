...
<section class="benefits-strip">
      ...
      <div class="row">
        ...
        <div class="col-md-3 category-item">
          <div class="category-box" style="background: #2ecc71;">
            <h3>Bricki</h3>
            <a href="{url entity='category' id=3}" class="btn btn-light">ZOBACZ WSZYSTKIE</a>
          </div>
        </div>
        <div class="col-md-3 category-item">
          <div class="category-box" style="background: #9b59b6;">
            <h3>100% plastik poker</h3>
            <a href="{url entity='category' id=4}" class="btn btn-light">ZOBACZ WSZYSTKIE</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="promotions">
    <div class="container">
      ...
      {widget name="ps_featuredproductsdiscounted"}
    </div>
  </section>
{/block}